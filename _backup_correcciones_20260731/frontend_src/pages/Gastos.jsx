                    ...
                    <tbody className="divide-y divide-gray-100">
                      {loadingCpp ? (
                        ...
                        <tr key={g.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          {cppColumnas.categoria && <td className="px-4 py-3"><CategoriaBadge categoria={g.categoria} /></td>}
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              <button onClick={() => handleEliminar(g.id)} disabled={deletingId === g.id} title="Eliminar"
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[92vh]">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-4">
              ...
              <div>
                <label className="text-xs font-semibold text-gray-700 uppercase">
                  {SUBCATEGORIAS[form.categoria] ? "Subcategoría *" : "Descripción *"}
                </label>
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-gray-700 uppercase">
                        {form.moneda === "USD" ? "Monto (US$) *" : aplicaIgv ? "Precio de Venta (S/) *" : "Monto (S/) *"}
                      </label>
                      <div className="relative mt-1.5">
                  ...
                  {form.tiene_detraccion && (() => {
                    ...
                    return (
                      <div className="space-y-4">
                        ...
                        <div>
                          <label className="text-xs font-semibold text-gray-700 uppercase">Tasa (%){form.concepto_detraccion === "Otro" ? " *" : ""}</label>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="mt-1"><CategoriaBadge categoria={verModal.categoria} /></div>
              </div>
              <div>
