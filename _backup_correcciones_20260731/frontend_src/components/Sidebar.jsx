...
import {
  HiChartBar, HiCurrencyDollar, HiCollection, HiCreditCard, HiCash,
...
const NAV_ITEMS = [
  ...
  { icon: HiCreditCard,            label: "Gastos",             path: "/gastos",        modulo: "gastos" },
  { icon: HiCash,                  label: "Pagos",              path: "/pagos",         modulo: "gastos" },
