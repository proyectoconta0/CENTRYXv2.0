    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="text-xs font-medium text-gray-600">{usuario ? "Nueva contraseña (opcional)" : "Contraseña temporal"}</label>
...
export default function UsuariosTab() {
  ...
  async function handleEliminar() {
    ...
    try {
      ...
      alert(e.response?.data?.detail || "No se pudo eliminar el usuario");
    } finally {
      setConfirmDel(null);
    }
  }
      ...
      {confirmDel && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
            ...
            <p className="text-sm text-gray-500 mb-4">¿Seguro que deseas eliminar a {confirmDel.nombre}?</p>
