...
function SeccionAreas() {
  ...
  async function handleEliminar() {
    ...
    try {
      ...
      setToast({ message: e.response?.data?.detail || "No se pudo eliminar el área", type: "error" });
    } finally {
      setConfirmDel(null);
    }
  }
  ...
  return (
    <div>
      ...
      <ConfirmDialog
        open={!!confirmDel}
        title="Eliminar área"
        message={confirmDel ? `¿Seguro que deseas eliminar "${confirmDel.nombre}"? Dejará de aparecer como opción al registrar gastos.` : ""}
        danger
