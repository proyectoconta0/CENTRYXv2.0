  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <div>
          <label className={LABEL_CLS}>RUC/DNI <span className="text-red-500">*</span></label>
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[92vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className={LABEL_CLS}>Fecha de Cobro <span className="text-red-500">*</span></label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className={LABEL_CLS}>Método de Cobro <span className="text-red-500">*</span></label>
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[92vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className={LABEL_CLS}>Monto a Devolver (S/) <span className="text-red-500">*</span></label>
            ...
            <div>
              <label className={LABEL_CLS}>Fecha de Devolución <span className="text-red-500">*</span></label>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[92vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className={LABEL_CLS}>Monto a Ejecutar (S/) <span className="text-red-500">*</span></label>
            ...
            <div>
              <label className={LABEL_CLS}>Fecha <span className="text-red-500">*</span></label>
              <input type="date" value={fecha} onChange={e => setFecha(e.target.value)} className={INPUT_CLS} />
            </div>
            <div>
              <label className={LABEL_CLS}>Motivo <span className="text-red-500">*</span></label>
            ...
            {aplicarA === "factura" && (
              <div>
                <label className={LABEL_CLS}>Factura a Saldar <span className="text-red-500">*</span></label>
                {loadingFacturas ? (
            ...
            {aplicarA === "recibo_interno" && (
              <div>
                <label className={LABEL_CLS}>Recibo Interno a Saldar <span className="text-red-500">*</span></label>
                {loadingRecibos ? (
