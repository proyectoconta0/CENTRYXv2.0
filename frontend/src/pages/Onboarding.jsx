    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white">
        <div className="text-center px-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">¡Bienvenido a Centryx!</h1>
          ...
          {paso === 1 && (
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-xs font-medium text-gray-600">Nombre de la empresa <span className="text-red-500">*</span></label>
