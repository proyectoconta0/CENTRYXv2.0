...
export default function Cotizaciones() {
  ...
  const handleConvertir = async (id) => {
    try { await convertirVenta(id); await cargar(); setToast({ message: "Cotización convertida a venta exitosamente", type: "success" }); }
    catch (err) { setToast({ message: err.response?.data?.detail || "Error al convertir", type: "error" }); }
  };
